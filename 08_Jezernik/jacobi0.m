function J = jacobi0(q)
	...
	% Inicializacija spremenljivk.
		...
		p0 = [0,0,0]';     % Vektor polozaja prvega sklepa glede na ref. k.s.
	...
	% 2. STOLPEC JACOBIJEVE PODMATRIKE
		...
		Jp(:,2) = cross(Tn(1:3,3), (p6-Tn(1:3,4)));                                        %%% STUDENT %%%
	...
	% 3. STOLPEC JACOBIJEVE PODMATRIKE
		...
		Jp(:,3) = cross(Tn(1:3,3), (p6-Tn(1:3,4)));                                        %%% STUDENT %%%
	...
	% 4. STOLPEC JACOBIJEVE PODMATRIKE
		...
		Jp(:,4) = cross(Tn(1:3,3), (p6-Tn(1:3,4)));                                        %%% STUDENT %%%
	...
	% 5. STOLPEC JACOBIJEVE PODMATRIKE
		...
		Jp(:,5) = cross(Tn(1:3,3), (p6-Tn(1:3,4)));                                        %%% STUDENT %%%
    ...
    % Izracun matrike Tn, ki vsebuje informacijo Zj-1 in Pj-1.
        ...
        Jp(:,6) = cross(Tn(1:3,3), (p6-Tn(1:3,4)));                                        %%% STUDENT %%%
